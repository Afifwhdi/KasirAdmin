...
export const ProductCard = memo(({ name, price, image, onAdd, isPluEnabled }: ProductCardProps) => {
  return (
    <Card
      className="p-4 cursor-pointer hover:shadow-md transition-shadow duration-150 active:scale-95 relative"
      onClick={onAdd}
    >
      {isPluEnabled && (
