...
export const DatabaseSettingsDialog = ({
  ...
  const handleSelectFolder = async () => {
    setIsSelecting(true);
    try {
      // Electron dialog untuk pilih folder
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        // Ask user to restart
        if (confirm('Aplikasi perlu di-restart untuk menggunakan database baru. Restart sekarang?')) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Pilih lokasi folder untuk menyimpan database POS. Database akan dibuat otomatis di folder yang dipilih.
          </DialogDescription>
        </DialogHeader>
