          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-base pt-2">
                Terima kasih telah menginstall POS System. Mari kita setup aplikasi Anda dalam 2 langkah mudah.
              </DialogDescription>
            </DialogHeader>
        ...
        {step === 'location' && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Pilih folder untuk menyimpan database POS Anda. Pastikan lokasi yang dipilih memiliki ruang yang cukup.
              </DialogDescription>
            </DialogHeader>
        ...
        {step === 'ready' && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Database akan disimpan di lokasi yang Anda pilih. Klik tombol di bawah untuk mulai download data dari server.
              </DialogDescription>
            </DialogHeader>
