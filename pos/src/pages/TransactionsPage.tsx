...
import { Search, Loader2, ChevronLeft, ChevronRight, Ban, Undo2 } from "lucide-react";
import { format } from "date-fns";
import { id } from "date-fns/locale";
import { useTransactions } from "@/features/transactions";
import { transactionsApi } from "@/features/transactions/services/api";
...
const TransactionsPage = () => {
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      await transactionsApi.updateStatus(actionDialog.transactionId, newStatus);
                  ...
                  <TableRow key={transaction.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center justify-center gap-2">
                        ...
                        {!canCancel(transaction.status) && !canRefund(transaction.status) && !canPay(transaction.status) && (
